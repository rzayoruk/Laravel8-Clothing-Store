...
class ShopcartController extends Controller
{
    ...
    {
        return \App\Models\Shopcart::where('user_id',Auth::id())->count();
    }
    ...
    public function store(Request $request,$id)
    {
        ...
        $data->save();
        return redirect()->back()->with('success','Product added into Shopcart Successfully');
    ...
    public function destroy(Shopcart $shopcart,$id)
    {
        ...
        $data->delete();
        $datalist=Shopcart::where('user_id',Auth::id())->get();
        return redirect()->route('user_shopcart')->with('success','Deleted');
    }
}
