...
class UserController extends Controller
{
    ...
    public function user_role_store(Request $request,User $user,$id)
    {
        ...
        $user->roles()->attach($roleid); // many to many-- using roleuser intertable
    ...
    public function user_role_delete(Request $request,User $user,$userid,$roleid)
    {
        ...
        $user->roles()->detach($roleid); // many to many-- using roleuser intertable
    ...
    public function update(Request $request, User $user,$id)
    {
        ...
        $data->save();
        return redirect()->route('admin_users')->with('success','User Info Updated');
