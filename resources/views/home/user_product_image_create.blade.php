    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{route('user_product_image_store',['product_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($images as $rows)
                        <tr role="row" class="odd">
                            ...
                            <td><a href="{{route('user_product_image_delete',['id'=>$rows->id])}}" onclick="return confirm('The record will be deleted Sure?')"><img src="{{asset('assets/admin/images')}}/delete.png" height="35" alt=""></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
